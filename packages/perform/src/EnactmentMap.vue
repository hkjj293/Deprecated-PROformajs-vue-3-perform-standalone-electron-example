  ...
  <svg ref="svg" width="100%" tabindex="0" :viewBox="viewbox">
    <template v-if="plan.tasks">
      <m-breadcrumb
        ...
        :width="(protocol.meta && protocol.meta.svg && protocol.meta.svg.width) || 800"
        :offset="0"
...
<script>
import EnactmentMapTask from './EnactmentMapTask.vue'
import { TemporalArrow, PathBreadcrumb } from '@openclinical/proformajs-vue3-map'
  ...
  computed: {
    ...
    viewbox() {
      if (this.protocol && this.protocol.meta && this.protocol.meta.svg) {
        ...
        return '0 0 800 ' + (400 + this.breadcrumb.height)
      }
    },
    ports() {
      let result = {}
