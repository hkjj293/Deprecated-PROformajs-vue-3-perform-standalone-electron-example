...
<template>
  <g ref="mapTask" class="task draggable" @dblclick="changePath">
    ...
    />
    <m-task-handle v-if="!no_handle" :x="handleX" :y="y + 20 + 16" />
    <text
      text-anchor="middle"
    ...
    <template v-if="clazz == 'decision'">
      <text
        v-for="(candidate, idx) in task.candidates"
        text-anchor="middle"
        :x="x + midline"
        :y="task.dataDefinitions.length > 0 ? y + 36 + 28 + idx * 14 : y + 36 + 14 + idx * 14"
        class="meta"
...
import { IconTask } from '@openclinical/proformajs-vue3-map'
import { IconDecision } from '@openclinical/proformajs-vue3-map'
import { IconPlan } from '@openclinical/proformajs-vue3-map'
import { IconEnquiry } from '@openclinical/proformajs-vue3-map'
import { IconAction } from '@openclinical/proformajs-vue3-map'
import { task_colors } from '@openclinical/proformajs-vue3-map'
