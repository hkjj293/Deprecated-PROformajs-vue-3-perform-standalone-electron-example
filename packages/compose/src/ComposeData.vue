    ...
    >
      <t-tab title="Details" key="details" id="c-data-tabs-details">
        <form>
          ...
          <c-textarea att="description" :comp="def" @change-attribute="updateAttribute" />
          <div class="row">
            <label for="dataDefinitionClass" class="col-form-label col-form-label-sm pt-0">
              Data type
            </label>
    ...
    addRangeItem() {
      ...
      if (this.rangeAnnotated) {
        this.def.range[this.def.range.length] = {
          value: this.getValue(this.$refs.rangeValue.value.trim()),
